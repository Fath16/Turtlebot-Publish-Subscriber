...
if("TRUE" STREQUAL "TRUE")
  set(twolink_description_SOURCE_PREFIX /home/theanvin/ws3/src/twolink_description)
  set(twolink_description_DEVEL_PREFIX /home/theanvin/ws3/devel)
  ...
  set(twolink_description_INSTALL_PREFIX /home/theanvin/ws3/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'theanvin <theanvin@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'twolink_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/theanvin/ws3/src/twolink_description/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/theanvin/ws3/devel/lib;/home/theanvin/ws3/devel/lib;/home/theanvin/catkin_ws/devel/lib;/opt/ros/noetic/lib)
